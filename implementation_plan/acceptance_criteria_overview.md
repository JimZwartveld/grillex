...
> **Note:** Phase 17 (Web Application Interface) has been moved to the separate `grillex-webapp` repository.
> See the grillex-webapp repository for implementation details and acceptance criteria.
