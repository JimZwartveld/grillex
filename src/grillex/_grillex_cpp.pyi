...
class InternalActions:
    ...
    @overload
    def __init__(
        self, x: float, N: float, Vy: float, Vz: float, Mx: float, My: float, Mz: float
    ) -> None: ...
...
class BeamElement(BeamElementBase):
    ...
    # Offset handling
    def set_offsets(
        self, offset_i: NDArray[np.float64], offset_j: NDArray[np.float64]
    ) -> None: ...
    ...
    def equivalent_nodal_forces(
        self, w_start: NDArray[np.float64], w_end: NDArray[np.float64]
    ) -> NDArray[np.float64]: ...

    # Displacements
    def get_element_displacements_local(
        self, global_displacements: NDArray[np.float64], dof_handler: "DOFHandler"
    ) -> NDArray[np.float64]: ...
...
def are_elements_collinear(
    elem1: BeamElement, elem2: BeamElement, tolerance: float = 1e-6
) -> bool: ...
...
class DOFHandler:
    ...
    def assign_dofs(self, nodes: List[Node], elements: List[BeamElement]) -> None: ...
    def get_global_dof(self, node_id: int, local_dof: DOFIndex) -> int: ...
    def get_warping_dof(self, element_id: int, node_id: int) -> int: ...
    def num_dofs(self) -> int: ...
...
class Assembler:
    ...
    def assemble_stiffness(
        self, elements: List[BeamElement], dof_handler: DOFHandler
    ) -> NDArray[np.float64]: ...
    def assemble_mass(
        self, elements: List[BeamElement], dof_handler: DOFHandler
    ) -> NDArray[np.float64]: ...
...
class BCHandler:
    ...
    def add_fixed_dof(
        self, node_id: int, dof: DOFIndex, value: float = 0.0
    ) -> None: ...
    def fix_node(self, node_id: int) -> None: ...
    def apply_to_system(
        self, K: NDArray[np.float64], F: NDArray[np.float64], dof_handler: DOFHandler
...
class LinearSolver:
    ...
    def solve(
        self, K: NDArray[np.float64], F: NDArray[np.float64]
    ) -> NDArray[np.float64]: ...
...
class LineLoad:
    ...
    def __init__(
        self, element_id: int, w_start: NDArray[np.float64], w_end: NDArray[np.float64]
    ) -> None: ...
...
class LoadCase:
    ...
    def __init__(
        self, name: str = "Default", load_type: LoadCaseType = LoadCaseType.Permanent
    ) -> None: ...
...
class EqualityConstraint:
    ...
    def __init__(
        self, master_dof: int, slave_dof: int, coefficient: float = 1.0
    ) -> None: ...
...
class ConstraintHandler:
    ...
    def add_rigid_link(
        self, master_node_id: int, slave_node_id: int, dof_handler: DOFHandler
    ) -> None: ...
    def reduce_system(
        self, K: NDArray[np.float64], F: NDArray[np.float64]
    ) -> ReducedSystem: ...
...
class Model:
    ...
    def create_section(
        self, name: str, A: float, Iy: float, Iz: float, J: float
    ) -> Section: ...
    ...
    def create_load_case(
        self, name: str, load_type: LoadCaseType = LoadCaseType.Permanent
    ) -> LoadCase: ...
