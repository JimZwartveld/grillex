...
class TestCantileverTipLoad:
    ...
    def test_moment_at_base(self):
        ...
        lc.add_nodal_load([n2.x, n2.y, n2.z], [0, -P, 0])  # Downward in Y
...
class TestAxialForce:
    ...
    def test_axial_tension(self):
        ...
        lc = model.get_default_load_case()
        lc.add_nodal_load([n2.x, n2.y, n2.z], [P, 0, 0])
...
class TestCantileverZDirection:
    ...
    def test_moment_about_y_axis(self):
        ...
        lc = model.get_default_load_case()
        lc.add_nodal_load([n2.x, n2.y, n2.z], [0, 0, -P])
...
class TestWarpingInternalActionsStruct:
    ...
    def test_warping_struct_accessible(self):
        ...
        lc = model.get_default_load_case()
        lc.add_nodal_load([n2.x, n2.y, n2.z], [0, 0, 0], [T, 0, 0])
...
class TestMidspanDisplacement:
    ...
    def test_midspan_displacement(self):
        ...
        lc.add_nodal_load([n2.x, n2.y, n2.z], [0, 0, 0], [0, 0, 10.0])
...
# NOTE: TestContinuousBeamBimomentContinuity and TestCantileverIBeamAnalyticalComparison
# have been moved to C++ in tests/cpp/test_internal_actions.cpp because
